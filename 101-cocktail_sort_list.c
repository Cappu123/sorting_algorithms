...
/**
 * swap_node_ahead - Swap a node in a listint_t with the node ahead of it.
...
/**
 * swap_node_behind - Swap a node in a listint_t with the one behind it
 * @list: pointer to the head of a doubly-linked list of integers.
 * @tail: pointer to the tail of the doubly-linked list.
...
/**
 * cocktail_sort_list - Sort a list of ints using the cocktail shaker algorithm
 * @list: Pointer to the head of a listint_t
 */
